...
void store()
{
    ...
    printf("|-----------------------------------------------------|\n");
    printf("|  1 ---------- Swimming goggles ----------       10$ |\n");
    printf("|  2 ---------- Swimwear         ----------       15$ |\n");
    ...
    if (scanf("%d", &choice) != 1)
    {
        ...
        case 1:
            ...
            case 3:
                ...
                {
                    money -= 1000000;
                    puts("Congratulation. Have a cool summer, here is your flag: ");
                    FILE *file;
                    long long number;
...
int main()
{
    puts("\n==================== Welcome to My Summer Store ====================\n");
    puts("\nWishing you all a bright and joyful summer! I'm Mr. Sunshine.\n\nI'm here to bring you a special gift. You can pick anything you like in this store. Make yourself at home and enjoy! Have an awesome day =)))\n\n");
    check_cash();
